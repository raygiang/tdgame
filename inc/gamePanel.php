  ...
  <button id="build-done" type="button">Done Building</button>
 	<div id="tower-select">
 		...
 		<table style="text-align:left">
 			<tbody>
 				<tr>
 					<td><label for="arrow-tower"><img class="tower_img" src="images/siegeBallista.png" alt="Arrow Tower"/> Arrow (250)</label></td>
 					<td><input type="radio" id="arrow-tower" name="tower_select" value="1" /></td>
 				</tr>
 				<tr>
 					<td><label for="laser-tower"><img class="tower_img" src="images/towerDefense__laser.png" alt="Laser Tower" /> Laser (750)</label></td>
 					<td><input type="radio" id="laser-tower" name="tower_select" value="2" /></td>
 				</tr>
 				<tr>
 					<td><label for="artillery-tower"><img class="tower_img" src="images/towerDefense_artillery.png" alt="Artillery Tower"/> Artillery (350)</label></td>
 					<td><input type="radio" id="artillery-tower" name="tower_select" value="3" /></td>
 				</tr>
 				<tr>
 					<td><label for="cannon-tower"><img class="tower_img" src="images/towerDefense_cannon.png" alt="Canon Tower"/> Cannon (500)</label></td>
